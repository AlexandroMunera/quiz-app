...
const BUY_ME_A_COFFEE_URL = "https://buymeacoffee.com/t5fdty9uob";
const BUY_ME_A_COFFEE_BADGE_URL =
    ...
    <div className={styles.container}>
      <div className={styles.scoreSection}>
        ...
        <MascotBubble
          ...
          size="md"
          variant={
            percentage >= 60 ? "success" : percentage >= 40 ? "info" : "error"
          }
        />

        {reaction.hint && (
          <p className={styles.motivationalHint}>{reaction.hint}</p>
        )}
        ...
        {isCoach && <span className={styles.levelBadge}>🧠 Coach Mode</span>}
          ...
          <div className={styles.signInBanner}>
            <div className={styles.signInBannerContent}>
              ...
              <div className={styles.signInBannerText}>
                <span className={styles.signInBannerTitle}>
                  Save your progress
                </span>
                <span className={styles.signInBannerSub}>
                  Sign in to sync Coach Mode data across devices
                </span>
              </div>
            </div>
            <button
        ...
        >
          <span className={styles.coffeeText}>Do you like your quiz?</span>
          <img
            className={styles.coffeeBadge}
            src={BUY_ME_A_COFFEE_BADGE_URL}
            alt="Buy Me a Coffee"
            width="217"
            height="60"
            loading="lazy"
